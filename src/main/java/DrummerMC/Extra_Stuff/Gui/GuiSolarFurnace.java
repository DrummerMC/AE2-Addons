package DrummerMC.Extra_Stuff.Gui;
...
public class GuiSolarFurnace extends GuiContainer
{
    ...
    public GuiSolarFurnace(InventoryPlayer par1InventoryPlayer, TileEntityFurnace par2TileEntityFurnace)
    {
        super(new ContainerSolarFurnace(par1InventoryPlayer, par2TileEntityFurnace));
